    ...
    return (
        <>
            ...
            <Section ID={"whatwedo"} header={"What We Do"}>
                ...
                <center><a href="/whatwedo"><Button variant="dark">Explore Our Services <i className="fa-solid fa-angle-right"></i></Button></a></center>
            </Section>
            <Section header={"Featured Products"} ID={"products"}>
                ...
                <center><a href="/products"><Button variant="dark">View All Products <i className="fa-solid fa-angle-right"></i></Button></a></center>
            </Section>
                    ...
                    <div className="form">
                        <form>
                            ...
                            style={{
                                ...
                                borderRadius : "10px",
                                fontFamily : "Sansation"
                            }} id="emailid" type="email" placeholder="example@example.com" className="p-2" /> <br />
                        </form>
                    </div>
                </div>
            </Section>
